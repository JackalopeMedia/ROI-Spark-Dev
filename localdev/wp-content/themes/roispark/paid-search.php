	...
	<div class="col-xs-9">
		<div id="widgetized-area">
			<div class="header-img">
				...
				<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('ppc-header-img')) : else : ?>
			...
			<div class="col-xs-9">
				<section class="row">
					<div id="about-us-area">
						...
						<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('paid-search-area')) : else : ?>
